...
int main() {
    ...
    // Esta variable no crea un servidor,
    // Almacena la direccion del servidor al que el cliente se quiere conectar

    printf("cliente[%d]: me estoy conectando con el servidor...\n", id);
    server_socket = socket(AF_UNIX, SOCK_STREAM, 0); // Aca tenemos al server, refiere a el
